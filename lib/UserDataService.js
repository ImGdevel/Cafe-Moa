...
export async function sendReservetionToUser(_cafeId, _time, _seatNumber) {
  //샘플 미구현
  //userId = await getCurrentUserId();
  userId = "eqaUnG8wKrQVZ6E4lG4JqZSXYQ62"; //테스트용, 삭제 가능
