...
export class CafeService{
    ...
    async addCafeDatabase(_data){
        ...
        console.log("2",cafe_datas.getLocation() , cafe_datas.getAddressAll())
        ...
        console.log(cafe_datas.getSeatId());
        ...
        if(cafe_datas.getLogo() == null){
            uploadImage(await pickImage(),"Cafe",id.id,"logo");
        }
        if(cafe_datas.getSeatImage() == null){
            uploadImage(await pickImage(),"Cafe",id.id,"seatImage");
        }
        */
        console.log("4")
        //인접 데이터 세팅
