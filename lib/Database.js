...
import { createNewSeatData, doSeatReservation, getSeatDataAll, loadSeatDataBase, UpdateSeatDataBase } from './ReservationService';
...
export async function addCafeDatabase(_data){
    ...
    //let sample = await loadSeatDataBase(seatid);
    //console.log("data > ",sample.getSeatDataFromTime(10));
