...
import { TimeTable, timeArray, SeatReservation } from './DataStructure/ReversationDataStructure';
...
export function testings(){
    ...
    timetable.timeArray[0] = new SeatReservation();

    timetable.insertOneTimeArray(10);

    

    timetable.timeArray[0].insert(10);
    timetable.timeArray[0].insert(20);
    timetable.timeArray[0].insert(30);

    let sample = timetable.getTime_Sample(9, 30);

    console.log(sample)
    console.log(timetable.timeArray[0]);
...
export async function addCafeDatabase(_data){
    ...
    */
    ...
    const timedata = timetable.timeArray[0].root;   

    let redada = [[100],[1000],[1000]];
    
    console.log(timedata)
    console.log(redada[0][0]);
